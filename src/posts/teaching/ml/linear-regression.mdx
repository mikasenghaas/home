...
$$
\begin{align*}RSS=L(\bold{y}, \bold{\hat{y}})&=\sum_i^n(y_i- \hat{f}(x_i)^2\\&=\sum_i^n(y_i-( \beta_0+\beta_1x_1+...+\beta_px_p))^2\\&=\sum_i^n(y_i- \beta_0-\beta_1x_1-...-\beta_px_p)^2\end{align*}
$$
