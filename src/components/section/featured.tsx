      ...
      <Frosted className="flex flex-col sm:flex-row gap-8 p-4 sm:p-8 min-h-[350px]">
        <div className="flex-1">
          ...
          <p className="mt-2 text-lg leading-snug 2xl:mt-6 2xl:text-2xl">
            I joined the research team at{" "}
            <a href="https://www.primeintellect.ai/" target="_blank" rel="noopener noreferrer">Prime Intellect</a> to make decentralized AI a reality. If you are in SF and would like to connect, let&apos;s grab a coffee, go for a run, or hack away.
          </p>
        </div>
